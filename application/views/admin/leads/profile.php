...
<div class="<?php if ($openEdit == true) {
    ...
    <?php if (isset($lead)) { ?>
    <div style="display:none;" class="btn-group pull-right mleft5" id="lead-more-btn">
    ...
    <div class="row">
        ...
        <div class="lead-edit<?php if (isset($lead)) { echo ' hide'; } ?>">
            ...
            //print_r( $rekeyedCustFields );die;
            ?>

            <?php //@aj New Contact Information section starts here ?>
            <div class="clearfix"></div>
            <div class="col-md-12">
                <label class="control-label"><b><?php echo _l('Lead Overview'); ?></b></label>
            </div>
            <?php //@aj Create/Edit screen Left section ?>
            <div class="col-md-<?php echo (isset($lead)) ? '3' : '6';?>">
                <?php
                    $selected = '';
                    if (isset($lead)) {
            ...
            <div class="col-md-3 <?php if (!isset($lead)) { echo ' hide'; } ?>">
                <?php
                    //echo render_cust_field($rekeyedCustFields['leads_remark'], false);
                    $leadRemark = lead_filter_remark_options( $rekeyedCustFields['leads_remark'], $selected );
                    echo render_cust_field($leadRemark, false);
                ?>
            </div>
           
            <?php //@aj Create/Edit screen Right section ?>
            <div class="col-md-6">
                <?php
                    $assigned_attrs = [];
            ...
            <div class="col-md-12">
                <label class="control-label"><b><?php echo _l('Contact Information'); ?></b></label>
            </div>
            <?php //@aj New Create/Edit screen Left section ?>
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-3">
                        <?php echo render_cust_field($rekeyedCustFields['leads_salutation'], false); ?>
                    </div>
                    <div class="col-md-9">
            ...
            <?php //@aj New Create/Edit screen Right section ?>
            <div class="col-md-6">
            ...
            <?php //@aj Product Information section starts here ?>
            <div class="clearfix"></div>
            <hr class="no-mtop mbot15" />
            <div class="col-md-12">
                <label class="control-label"><b><?php echo _l('Product Information'); ?></b></label>
            </div>
            <?php //@aj Create/Edit screen Left section ?>
            <div class="col-md-6">
                <?php echo render_cust_field( $rekeyedCustFields['leads_business_unit'], false ); ?>
            </div>
            <?php //@aj Create/Edit screen Right section ?>
            <div class="col-md-6">
                <?php echo render_cust_field( $rekeyedCustFields['leads_products_or_services'], false ); ?>
            </div>

            <?php //@aj  Other Data section starts here ?>
            <div class="clearfix"></div>
            <hr class="no-mtop mbot15" />
            <div class="col-md-12">
                <label class="control-label"><b><?php echo _l('Company Information'); ?></b></label>
            </div>
            <div class="col-md-6">
                <?php //@aj Create/Edit screen Left section ?>
                ...
                <?php echo render_cust_field( $rekeyedCustFields['leads_company_employees'], false); ?>

                <?php echo render_cust_field( $rekeyedCustFields['leads_industry'], false ); ?>

            </div>
            <div class="col-md-6">
                <?php //@aj Create screen Right section ?>
                ...
                <?php if ( false &&  !is_language_disabled()) { ?>
                <div class="form-group">
            ...
            <?php //@aj Lead Information section starts here ?>
            <div class="clearfix"></div>
            <hr class="no-mtop mbot15" />
            <div class="col-md-12">
                <label class="control-label"><b><?php echo _l('Lead Information'); ?></b></label>
            </div>
            <?php //@aj New Create/Edit screen Left section ?>
            <div class="col-md-6">


                <?php echo render_cust_field( $rekeyedCustFields['leads_campaign_name'], false ); ?>
                ...
                <?php echo render_cust_field( $rekeyedCustFields['leads_lead_type'], false ); ?>

            </div>
            <?php //@aj Create/Edit screen Right section ?>
            <div class="col-md-6">

                <?php echo render_cust_field( $rekeyedCustFields['leads_campaign_budget'], false ); ?>

                <?php $value = (isset($lead) ? $lead->description : ''); ?>
                <?php echo render_textarea('description', 'lead_description', $value, ['rows'=>1]); ?>

                <?php echo render_cust_field( $rekeyedCustFields['leads_lead_source_url'], false ); ?>
...
$(document).ready(function() {
    $('select[name="status"]').on('change', function() {
        // Get the selected value of the status select box
        var selectedStatus = $(this).selectpicker('val');
        console.log(selectedStatus);

        // Define the options array
        var optionsArray =  <?php echo json_encode( lead_get_remark_options() ); ?>;
        //console.log( optionsArray );

        // Target the specific select element
        //var $remarkSelect = $('select[name="custom_fields[leads][17]"]');
        var $remarkSelect = $('#cf-div-leads_remark').find('select');


        // Clear the existing options
        $remarkSelect.empty();

        // Get the options for the selected status
        var newOptions = optionsArray[selectedStatus] || [];

        // Add the new options
        $.each(newOptions, function(index, value) {
            $remarkSelect.append($('<option></option>').val(value).text(value));
        });

        // Refresh the selectpicker to update the UI
        $remarkSelect.selectpicker('refresh');
