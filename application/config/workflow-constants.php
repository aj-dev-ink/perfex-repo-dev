    ...
    define('WF_FIELD_OPTION_MAP',
        array( 
            WF_ENTITY_TYPE['Lead'] => [
                ...
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Time zone']                 => ['field_name' => 'Time zone', 'is_textbox'=>false, 'function_name' => '_getTimeZoneOptions'],
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['City']                      => ['field_name' => 'City', 'is_textbox'=>true, 'function_name' => 'getCityOptions'],
                ...
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Country']                   => ['field_name' => 'Country', 'is_textbox'=>false, 'function_name' => '_getCountryOptions'],
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Department']                => ['field_name' => 'Department', 'is_textbox'=>true, 'function_name' => 'getUserOptions'],
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Do not disturb']            => ['field_name' => 'Do not disturb', 'is_textbox'=>false, 'function_name' => '_getYesNoOptions'],
                ...
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Company country']           => ['field_name' => 'Company country', 'is_textbox'=>false, 'function_name' => '_getCountryOptions'],
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Company employees']         => ['field_name' => 'Company employees', 'is_textbox'=>true, 'function_name' => '_getCompEmloyeeOptions'],
                ...
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Company industry']          => ['field_name' => 'Company industry', 'is_textbox'=>false, 'function_name' => '_getCompIndustryOptions'],
                ...
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Currency']                  => ['field_name' => 'Currency', 'is_textbox'=>false, 'function_name' => '_getCurrencyOptions'],
                ...
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Products or services']      => ['field_name' => 'Products or services', 'is_textbox'=>false, 'function_name' => '_getProductServicesOptions'],
                ...
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Campaign']                  => ['field_name' => 'Campaign', 'is_textbox'=>false, 'function_name' => '_getCampaignOptions'],
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Lead source']               => ['field_name' => 'Lead source', 'is_textbox'=>false, 'function_name' => '_getLeadSourceOptions'],
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Imported by']               => ['field_name' => 'Imported by', 'is_textbox'=>false, 'function_name' => '_getUserOptions'],
                ...
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Is MQL ?']                  => ['field_name' => 'Is MQL ?', 'is_textbox'=>false, 'function_name' => '_getYesNoOptions'],
                ...
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Business unit']             => ['field_name' => 'Business unit', 'is_textbox'=>false, 'function_name' => '_getBuissnessUnit'],
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Automation activate']       => ['field_name' => 'Automation activate', 'is_textbox'=>false, 'function_name' => '_getYesNoOptions'],
                ...
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Is new']                    => ['field_name' => 'Is new', 'is_textbox'=>false, 'function_name' => '_getYesNoOptions'],
                WF_FIELD_MAP[WF_ENTITY_TYPE['Lead']]['Forecasting type']          => ['field_name' => 'Forecasting type', 'is_textbox'=>false, 'function_name' => '_getForastingType'],
            ],
            WF_ENTITY_TYPE['Task'] => [
