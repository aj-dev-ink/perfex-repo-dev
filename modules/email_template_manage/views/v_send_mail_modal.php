            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <?php } else { ?>
                        ...
                        <div class="col-md-12">
                            <?php echo render_input('mail_to',_l('email_template_manage_to'), !empty( $mail_to ) ? $mail_to : '', 'email' , [ 'required' => true ] ); ?>
                        </div>
                    ...
                    <div class="col-md-12">
                        <?php echo render_input('mail_cc',_l('email_template_manage_cc') , !empty( $mail_cc ) ? $mail_cc : '' , 'email'); ?>
                    </div>

                    <div class="col-md-12">
                        <?php echo render_input('subject',_l('email_template_manage_email_subject'),!empty( $mail_subject ) ? $mail_subject : '' ,'' , [ 'required' => true ] ); ?>
                    </div>

                    <div class="col-md-12">

                        <textarea class="tinymce tinymce-manual" id="template_content" name="template_content"><?php echo !empty( $mail_description ) ? $mail_description : '' ?></textarea>
